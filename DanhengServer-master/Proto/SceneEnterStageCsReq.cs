...
namespace EggLink.DanhengServer.Proto {
    ...
    static SceneEnterStageCsReqReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "b3RvImMKFFNjZW5lRW50ZXJTdGFnZUNzUmVxEhMKC0VKR1BDSVBIRUVEGAwg",
            "ASgIEiQKDXJlYmF0dGxlX3R5cGUYDiABKA4yDS5SZWJhdHRsZVR5cGUSEAoI",
            "ZXZlbnRfaWQYDyABKA1CHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Qcm90",
            "b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.RebattleTypeReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.SceneEnterStageCsReq), global::EggLink.DanhengServer.Proto.SceneEnterStageCsReq.Parser, new[]{ "EJGPCIPHEED", "RebattleType", "EventId" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public SceneEnterStageCsReq(SceneEnterStageCsReq other) : this() {
      eJGPCIPHEED_ = other.eJGPCIPHEED_;
    ...
    /// <summary>Field number for the "EJGPCIPHEED" field.</summary>
    public const int EJGPCIPHEEDFieldNumber = 12;
    private bool eJGPCIPHEED_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool EJGPCIPHEED {
      get { return eJGPCIPHEED_; }
      set {
        eJGPCIPHEED_ = value;
      }
    }
    ...
    public bool Equals(SceneEnterStageCsReq other) {
      ...
      if (EJGPCIPHEED != other.EJGPCIPHEED) return false;
    ...
    public override int GetHashCode() {
      int hash = 1;
      if (EJGPCIPHEED != false) hash ^= EJGPCIPHEED.GetHashCode();
    ...
    #else
      if (EJGPCIPHEED != false) {
        output.WriteRawTag(96);
        output.WriteBool(EJGPCIPHEED);
      }
