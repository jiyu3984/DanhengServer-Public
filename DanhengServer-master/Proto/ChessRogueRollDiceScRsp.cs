...
namespace EggLink.DanhengServer.Proto {
    ...
    static ChessRogueRollDiceScRspReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "Z3VlX2RpY2VfaW5mbxgMIAEoCzITLkNoZXNzUm9ndWVEaWNlSW5mbxIPCgdy",
            "ZXRjb2RlGAkgASgNEhMKC05DS01DSUpDS0dCGAcgASgNQh6qAhtFZ2dMaW5r",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ChessRogueRollDiceScRsp), global::EggLink.DanhengServer.Proto.ChessRogueRollDiceScRsp.Parser, new[]{ "RogueDiceInfo", "Retcode", "NCKMCIJCKGB" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ChessRogueRollDiceScRsp(ChessRogueRollDiceScRsp other) : this() {
      ...
      nCKMCIJCKGB_ = other.nCKMCIJCKGB_;
    ...
    /// <summary>Field number for the "NCKMCIJCKGB" field.</summary>
    public const int NCKMCIJCKGBFieldNumber = 7;
    private uint nCKMCIJCKGB_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public uint NCKMCIJCKGB {
      get { return nCKMCIJCKGB_; }
      set {
        nCKMCIJCKGB_ = value;
      }
    }
    ...
    public bool Equals(ChessRogueRollDiceScRsp other) {
      ...
      if (NCKMCIJCKGB != other.NCKMCIJCKGB) return false;
    ...
    public override int GetHashCode() {
      ...
      if (NCKMCIJCKGB != 0) hash ^= NCKMCIJCKGB.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (NCKMCIJCKGB != 0) {
        ...
        output.WriteUInt32(NCKMCIJCKGB);
      }
      if (Retcode != 0) {
    ...
    public int CalculateSize() {
      ...
      if (NCKMCIJCKGB != 0) {
        size += 1 + pb::CodedOutputStream.ComputeUInt32Size(NCKMCIJCKGB);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(ChessRogueRollDiceScRsp other) {
      ...
      if (other.NCKMCIJCKGB != 0) {
        NCKMCIJCKGB = other.NCKMCIJCKGB;
      }
