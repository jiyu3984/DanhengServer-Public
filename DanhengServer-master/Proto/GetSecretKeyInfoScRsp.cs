...
namespace EggLink.DanhengServer.Proto {
    ...
    static GetSecretKeyInfoScRspReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "cHJvdG8iYgoVR2V0U2VjcmV0S2V5SW5mb1NjUnNwEg8KB3JldGNvZGUYCCAB",
            "KA0SEwoLQUJHS0tEQ0lLR08YASABKAwSIwoLc2VjcmV0X2luZm8YCyADKAsy",
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.GetSecretKeyInfoScRsp), global::EggLink.DanhengServer.Proto.GetSecretKeyInfoScRsp.Parser, new[]{ "Retcode", "ABGKKDCIKGO", "SecretInfo" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public GetSecretKeyInfoScRsp(GetSecretKeyInfoScRsp other) : this() {
      ...
      aBGKKDCIKGO_ = other.aBGKKDCIKGO_;
    ...
    /// <summary>Field number for the "ABGKKDCIKGO" field.</summary>
    public const int ABGKKDCIKGOFieldNumber = 1;
    private pb::ByteString aBGKKDCIKGO_ = pb::ByteString.Empty;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public pb::ByteString ABGKKDCIKGO {
      get { return aBGKKDCIKGO_; }
      set {
        aBGKKDCIKGO_ = pb::ProtoPreconditions.CheckNotNull(value, "value");
      }
    }

    /// <summary>Field number for the "secret_info" field.</summary>
    public const int SecretInfoFieldNumber = 11;
    private static readonly pb::FieldCodec<global::EggLink.DanhengServer.Proto.SecretKeyInfo> _repeated_secretInfo_codec
        = pb::FieldCodec.ForMessage(90, global::EggLink.DanhengServer.Proto.SecretKeyInfo.Parser);
    ...
    public bool Equals(GetSecretKeyInfoScRsp other) {
      ...
      if (ABGKKDCIKGO != other.ABGKKDCIKGO) return false;
    ...
    public override int GetHashCode() {
      ...
      if (ABGKKDCIKGO.Length != 0) hash ^= ABGKKDCIKGO.GetHashCode();
    ...
    #else
      if (ABGKKDCIKGO.Length != 0) {
        output.WriteRawTag(10);
        output.WriteBytes(ABGKKDCIKGO);
      }
      if (Retcode != 0) {
    ...
    public int CalculateSize() {
      ...
      if (ABGKKDCIKGO.Length != 0) {
        size += 1 + pb::CodedOutputStream.ComputeBytesSize(ABGKKDCIKGO);
      }
    ...
    public void MergeFrom(GetSecretKeyInfoScRsp other) {
      ...
      if (other.ABGKKDCIKGO.Length != 0) {
        ABGKKDCIKGO = other.ABGKKDCIKGO;
      }
