...
namespace EggLink.DanhengServer.Proto {
    ...
    static ChallengeListReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bGxlbmdlX2lkGA0gASgNEhMKC0JOTU9DQkROQkRPGAwgASgIEgwKBHN0YXIY",
            "CSABKA1CHqoCG0VnZ0xpbmsuRGFuaGVuZ1NlcnZlci5Qcm90b2IGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.ChallengeList), global::EggLink.DanhengServer.Proto.ChallengeList.Parser, new[]{ "ChallengeId", "BNMOCBDNBDO", "Star" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public ChallengeList(ChallengeList other) : this() {
      ...
      bNMOCBDNBDO_ = other.bNMOCBDNBDO_;
      star_ = other.star_;
    ...
    /// <summary>Field number for the "BNMOCBDNBDO" field.</summary>
    public const int BNMOCBDNBDOFieldNumber = 12;
    private bool bNMOCBDNBDO_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public bool BNMOCBDNBDO {
      get { return bNMOCBDNBDO_; }
      set {
        bNMOCBDNBDO_ = value;
      }
    }
    ...
    public bool Equals(ChallengeList other) {
      ...
      if (BNMOCBDNBDO != other.BNMOCBDNBDO) return false;
    ...
    public override int GetHashCode() {
      ...
      if (BNMOCBDNBDO != false) hash ^= BNMOCBDNBDO.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (BNMOCBDNBDO != false) {
        output.WriteRawTag(96);
        output.WriteBool(BNMOCBDNBDO);
      }
      if (ChallengeId != 0) {
    ...
    public void MergeFrom(ChallengeList other) {
      ...
      if (other.BNMOCBDNBDO != false) {
        BNMOCBDNBDO = other.BNMOCBDNBDO;
      }
      if (other.Star != 0) {
        Star = other.Star;
      }
