...
namespace EggLink.DanhengServer.Proto {
    ...
    static SyncRogueGetItemScNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "aXN0GAEgASgLMgkuSXRlbUxpc3QSHgoLTElGTElERk9BQ0QYCiABKAsyCS5J",
            "dGVtTGlzdEIeqgIbRWdnTGluay5EYW5oZW5nU2VydmVyLlByb3RvYgZwcm90",
            "bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::EggLink.DanhengServer.Proto.ItemListReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::EggLink.DanhengServer.Proto.SyncRogueGetItemScNotify), global::EggLink.DanhengServer.Proto.SyncRogueGetItemScNotify.Parser, new[]{ "GetItemList", "LIFLIDFOACD" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public SyncRogueGetItemScNotify(SyncRogueGetItemScNotify other) : this() {
      ...
      lIFLIDFOACD_ = other.lIFLIDFOACD_ != null ? other.lIFLIDFOACD_.Clone() : null;
    ...
    /// <summary>Field number for the "LIFLIDFOACD" field.</summary>
    public const int LIFLIDFOACDFieldNumber = 10;
    private global::EggLink.DanhengServer.Proto.ItemList lIFLIDFOACD_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::EggLink.DanhengServer.Proto.ItemList LIFLIDFOACD {
      get { return lIFLIDFOACD_; }
      set {
        lIFLIDFOACD_ = value;
      }
    }
    ...
    public bool Equals(SyncRogueGetItemScNotify other) {
      ...
      if (!object.Equals(LIFLIDFOACD, other.LIFLIDFOACD)) return false;
    ...
    public override int GetHashCode() {
      ...
      if (lIFLIDFOACD_ != null) hash ^= LIFLIDFOACD.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (lIFLIDFOACD_ != null) {
        output.WriteRawTag(82);
        output.WriteMessage(LIFLIDFOACD);
      }
      if (_unknownFields != null) {
    ...
    public int CalculateSize() {
      ...
      if (lIFLIDFOACD_ != null) {
        size += 1 + pb::CodedOutputStream.ComputeMessageSize(LIFLIDFOACD);
      }
      if (_unknownFields != null) {
    ...
    public void MergeFrom(SyncRogueGetItemScNotify other) {
      ...
      if (other.lIFLIDFOACD_ != null) {
        if (lIFLIDFOACD_ == null) {
          LIFLIDFOACD = new global::EggLink.DanhengServer.Proto.ItemList();
        }
        LIFLIDFOACD.MergeFrom(other.LIFLIDFOACD);
      }
